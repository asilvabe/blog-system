        ...
        <div class="flex flex-col my-4">
            <form action="{{ route('posts.index') }}" method="get">
                <div class="grid gap-6 mb-6 md:grid-cols-5">
                    <div>
                        ...
                        <input type="text" id="title_search" name="title_search"
                            ...
                            placeholder="Title Search" value="{{ request()->get('title_search') ?? '' }}">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <select id="author" name="author"
                            ...
                            @foreach ($users as $user)
                                <option value='{{ $user->id }}' @selected(request()->get('author') == $user->id)>{{ $user->name }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="flex items-center">
                    <button type="submit"
                        class="bg-blue-800 text-white font-bold text-sm uppercase rounded hover:bg-blue-700 flex items-center justify-center px-5 py-3">Search</button>
